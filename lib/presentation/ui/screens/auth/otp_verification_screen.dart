...
class _OTPVerificationScreenState extends State<OTPVerificationScreen> {
  ...
  OtpVerificationController otpVerificationController = Get.find<OtpVerificationController>();
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(
                            text: '${otpVerificationController.start} s',
                    ...
                    TextButton(
                      onPressed: otpVerificationController.canResend ? () {
                        otpVerificationController.startTimer();
                      } : null,
                      style: TextButton.styleFrom(
                          foregroundColor: otpVerificationController.canResend ? Colors.blue : Colors.black),
